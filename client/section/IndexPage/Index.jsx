        ...
        return (
            <div className={styles.indexPage}>
                ...
                <ul>
                    <li>
                        <span>账号：</span>
                        <input value={this.state.name} onChange={(e) => this.setState({ name: e.target.value, saved: false })} />
                    </li>
                    <li>
                        <span>密码：</span>
                        <input value={this.state.pwd} onChange={(e) => this.setState({ pwd: e.target.value, saved: false })} />
                    </li>
                </ul>
                <div className={styles.btn} onClick={this.submit.bind(this)}>提交</div>
